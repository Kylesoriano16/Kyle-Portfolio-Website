    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          Welcome to my portfolio! I’m Kyle Kriztian, a passionate developer specializing in crafting immersive, innovative web experiences with expertise in React, Next.js, and Three.js.
          </p>
